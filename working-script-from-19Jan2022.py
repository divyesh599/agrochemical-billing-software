...
imglogo=PhotoImage(file="img/maganbhai-logo.png")
...
link1=Label(FFoot, text=" by ", font=("MV Boli", 9, "bold"), fg="#264653", bg=colbg).pack(side=LEFT)
link2=Label(FFoot, image=imglogo, bd=0)
link2.pack(side=LEFT)
link3=Label(FFoot, text=" (Divyesh Ranpariya, Mo. 9601500840)", font=("MV Boli", 9, "bold"), fg="#264653", bg=colbg)
link3.pack(side=LEFT)
link2.bind("<Button-1>", lambda e: webbrowser.open_new("https://www.facebook.com/divyesh599/"))
link3.bind("<Button-1>", lambda e: webbrowser.open_new("https://www.facebook.com/divyesh599/"))
